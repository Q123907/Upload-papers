...
def wechat_index():
    return render_template('distsjlr/test/index.html')
@main.route('/wechat/login')
def wechat_login2():
    return render_template('distsjlr/login/login2.html')
@main.route('/wechat/upload')
def wechat_upload():
    return render_template('distsjlr/test/upload_record.html')
