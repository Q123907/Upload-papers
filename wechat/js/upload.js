...
$(function () {
    ...
    $.ajax({
        ...
        url: "http://192.168.31.247:5000/api/paper/upload?pageIndex=0",
        crossDomain: true,
        type: "get",
//                data: JSON.stringify({user_name: "test1", password: "123456"}),
        ...
        success: function(data) {
            ...
            $.each(data.data.items,function (index,elme) {
                ...
                alert("请登入后访问")
                window.location.href="http://192.168.31.247:5000/wechat/login";
            }
            // $(".logout").show();
...
//                $("#shangchuang").hide();
              ...
              $.ajax({
                  ...
                  url:'http://192.168.31.247:5000/api/uploads',
                  type:'post',
...
//        var somearray = ["mon", "tue", "wed", "thur"]
      ...
      $gallery.on("click", function(){
          ...
          $.ajax({
              url: "http://192.168.31.247:5000/api/paper/upload/"+$(this).attr("id"),
...
// //
    ...
    $("#submit").click(function () {
        ...
        { alert('请选择图片')}
            ...
            $.ajax({
                url:'http://192.168.31.247:5000/api/paper/upload/'+uploadid,
...
//                cache: false,
                ...
                success:function (date){
                    ...
                    window.location.href="http://192.168.31.247:5000/wechat/upload";
                },
                error:function () {
                    alert("ajax错误");
                }
...
//             url: "http://192.168.31.247:5000/api/logout/",
//             crossDomain: true,
//             type: "get",
